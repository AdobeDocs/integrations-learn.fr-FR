---
title: Tutoriel sur l [!DNL Campaign] intégration de Standard à  [!DNL Analytics] à l’aide de Triggers
...
# Tutoriel sur l’intégration d’[!DNL Campaign] Standard à [!DNL Analytics] à l’aide de Triggers

Découvrez comment configurer et utiliser des déclencheurs pour la messagerie transactionnelle.

## Configurer la collecte de données Adobe Experience [!DNL Platform] pour les déclencheurs

Découvrez comment effectuer la collecte de données Adobe Experience [!DNL Platform] et ajouter les propriétés requises à votre site web pour tester votre configuration.
