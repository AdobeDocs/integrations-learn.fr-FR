---
title: Intégrer le Parcours client  [!DNL Analytics]   [!DNL Real-Time Customer Data Platform]
...
# Intégrer les [!DNL Analytics] de Parcours client à Real-Time Customer Data [!DNL Platform]
